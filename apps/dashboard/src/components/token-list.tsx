...
const TokenRow = memo(function TokenRow({ token, isRevoking, onRevoke }: TokenRowProps) {
    ...
    <div className="rounded-lg border border-border bg-card p-4">
      <div className="mb-3 flex items-start justify-between">
        ...
        <div className="ml-4 flex gap-2">
          <Button variant="outline" size="sm" onClick={handleRevokeClick} disabled={isRevoking}>
            {isRevoking ? "処理中..." : "失効"}
          </Button>
        </div>
      </div>
